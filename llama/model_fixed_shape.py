...
def precompute_freqs_cis(dim: int, end: int, theta: float = 10000.0):
    ...
    freqs_cis = polar(torch.ones_like(freqs), freqs) #float, shape is [real, imag, 2]
    return freqs_cis
...
def complex_multiply(a, b):
    # Split real and imaginary parts of tensors
    a_real = a[..., 0]
    a_imag = a[..., 1]
    b_real = b[..., 0]
    b_imag = b[..., 1]
    ...
    # Concatenate real and imaginary parts and return
...
def apply_rotary_emb(
    ...
    xq_out = complex_multiply(xq_ , freqs_cis).flatten(3)
    xk_out = complex_multiply(xk_ , freqs_cis).flatten(3)
...
class FeedForward(nn.Module):
    def __init__(
        ...
        # dim = 4096, hidden_dim =11008 //// 4096 * 11008 *3 * 32 =4300000000
        self.w1 = nn.Linear(
